...
public class HealthcareLocationController : ApiControllerBase
{
    ...
    public async Task<ActionResult> Create([FromBody] Medport.Application.Tracc.Features.Facilities.Commands.Requests.CreateFacilityCommand command, CancellationToken cancellationToken)
    {
        ...
        return Ok(ApiResponse<Medport.Application.Tracc.Features.Facilities.Queries.Dtos.FacilityDto>.Ok(data, "Location created successfully"));
    }
    ...
    public async Task<ActionResult> Update(Guid id, [FromBody] Medport.Application.Tracc.Features.Facilities.Commands.Requests.UpdateFacilityCommand command, CancellationToken cancellationToken)
    {
        command.Id = id;
        var data = await Mediator.Send(command, cancellationToken);
        return Ok(ApiResponse<Medport.Application.Tracc.Features.Facilities.Queries.Dtos.FacilityDto>.Ok(data, "Location updated successfully"));
    }
    ...
    {
        await Mediator.Send(new Medport.Application.Tracc.Features.Facilities.Commands.Requests.DeleteFacilityCommand(id), cancellationToken);
    ...
    {
        var data = await Mediator.Send(new Medport.Application.Tracc.Features.Facilities.Queries.Requests.GetAllFacilitiesWithPaginationQuery { Page = 0, Limit = int.MaxValue }, cancellationToken);
        return Ok(ApiResponse<List<Medport.Application.Tracc.Features.Facilities.Queries.Dtos.FacilityDto>>.Ok([.. data.Items]));
    }

    [HttpGet("active")]
    public async Task<ActionResult> GetActive(CancellationToken cancellationToken)
    {
        var data = await Mediator.Send(new Medport.Application.Tracc.Features.Facilities.Queries.Requests.GetAllFacilitiesWithPaginationQuery { Page = 0, Limit = int.MaxValue, IsActive = true }, cancellationToken);
        return Ok(ApiResponse<List<Medport.Application.Tracc.Features.Facilities.Queries.Dtos.FacilityDto>>.Ok([.. data.Items]));
    }
    ...
    public async Task<ActionResult> GetStatistics(CancellationToken cancellationToken)
    {
        ...
        var all = await Mediator.Send(new Medport.Application.Tracc.Features.Facilities.Queries.Requests.GetAllFacilitiesWithPaginationQuery { Page = 0, Limit = int.MaxValue }, cancellationToken);
    ...
    {
        await Mediator.Send(new Medport.Application.Tracc.Features.Facilities.Commands.Requests.SetPrimaryFacilityCommand(id), cancellationToken);
        return Ok(ApiResponse<object>.Ok(null, "Primary location set"));
    }

    [HttpPut("{id}/admin")]
    public async Task<ActionResult> AdminUpdate(Guid id, [FromBody] Medport.Application.Tracc.Features.Facilities.Commands.Requests.AdminUpdateFacilityCommand command, CancellationToken cancellationToken)
    {
        command.Id = id;
        var data = await Mediator.Send(command, cancellationToken);
        return Ok(ApiResponse<Medport.Application.Tracc.Features.Facilities.Queries.Dtos.FacilityDto>.Ok(data, "Location updated by admin"));
    }
}
