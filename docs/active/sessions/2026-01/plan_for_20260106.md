...
**⚠️ Known Issue:**
- `npm install` may hang in Azure (we've seen this before)
- If it hangs, we may need to investigate why or use alternative dependency installation method
...
5. ✅ **Backend Startup In Progress:**
   ...
   - ⏳ **Currently:** `npm install --production` is running (this may take 5-15 minutes)
   - **What to watch for:**
     ...
     - ⚠️ If `npm install` hangs (no output for 20+ minutes), we may need to investigate
