...
-- CreateTable
CREATE TABLE IF NOT EXISTS "trip_cost_breakdowns" (
    "id" TEXT NOT NULL,
...
-- Create index on tripId for faster lookups
CREATE INDEX IF NOT EXISTS "trip_cost_breakdowns_tripId_idx" ON "trip_cost_breakdowns"("tripId");

-- Note: Foreign key to trips table is not created as trips table may not have the exact structure
-- This table stores cost breakdown data for trips and can be linked via tripId
