...
/** Static fallback plans when API is unavailable (matches backend seed data) */
const FALLBACK_PLANS: Record<'HEALTHCARE' | 'EMS', SubscriptionPlan[]> = {
  HEALTHCARE: [
    {
      id: 'healthcare-free-plan',
      name: 'FREE',
      ...
      monthlyPrice: '0',
      annualPrice: '0',
      features: ['Create transport requests', 'View available EMS providers', 'Track transport status', 'Basic analytics', 'Email notifications'],
      trialDays: 7,
      isActive: true,
    },
    {
      id: 'healthcare-regular-plan',
      name: 'REGULAR',
      ...
      monthlyPrice: '99',
      annualPrice: '990',
      features: ['All Free Trial features', 'Unlimited transport requests', 'Advanced analytics and reporting', 'Priority support', 'SMS notifications', 'Multi-location management', 'Custom integrations'],
      trialDays: 0,
      isActive: true,
    },
    {
      id: 'healthcare-premium-plan',
      name: 'PREMIUM',
      ...
      monthlyPrice: '299',
      annualPrice: '2990',
      features: ['All Regular Plan features', 'Dedicated account manager', 'Custom API access', 'Advanced route optimization', 'White-label options', '24/7 phone support', 'Custom training sessions'],
      trialDays: 0,
      isActive: true,
    },
  ],
  EMS: [
    {
      ...
      monthlyPrice: '0',
      annualPrice: '0',
      features: ['Receive trip notifications', 'View available trips', 'Accept/decline requests', 'Track completed transports', 'Basic analytics'],
      trialDays: 7,
      isActive: true,
    },
    {
      ...
      monthlyPrice: '79',
      annualPrice: '790',
      features: ['All Free Trial features', 'Unlimited trip responses', 'Advanced analytics and reporting', 'Priority trip notifications', 'SMS notifications', 'Multi-unit management', 'Route optimization'],
      trialDays: 0,
      isActive: true,
    },
    {
      ...
      monthlyPrice: '199',
      annualPrice: '1990',
      features: ['All Regular Plan features', 'Dedicated account manager', 'Custom API access', 'Advanced route optimization', 'Revenue analytics', '24/7 phone support', 'Custom training sessions'],
      trialDays: 0,
      isActive: true,
    },
  ],
  ...
  const fetchPlans = async () => {
    try {
      ...
      if (response.data.success && Array.isArray(response.data.data) && response.data.data.length > 0) {
        ...
        setPlans(FALLBACK_PLANS[selectedUserType]);
      }
    } catch (err) {
