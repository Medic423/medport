        ...
        if (response.data?.success && response.data?.data) {
          ...
          setAgencyInfo(prev => ({
            ...
            operatingHours: data.operatingHours && typeof data.operatingHours === 'object'
              ...
              : prev.operatingHours,
            smsNotifications: data.smsNotifications !== undefined ? data.smsNotifications : (data.acceptsNotifications !== undefined ? data.acceptsNotifications : prev.smsNotifications)
          }));
        } else {
